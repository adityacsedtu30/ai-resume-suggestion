...
import { getReportById, downloadResumePdf } from "../api/interview.api"
...
export default function Interview() {
    ...
    // Fetch this one report whenever the id in the URL changes.
    useEffect(() => {
        setLoading(true)
        setError("")
        getReportById(interviewId)
            .then(setReport)
            .catch(() => setError("Could not load this interview plan."))
    ...
    if (error || !report) return <main className="loading-screen"><h1>{error || "Not found."}</h1></main>
        ...
        <div className="interview-page">
            <div className="interview-layout">
                ...
                <nav className="interview-nav">
                    ...
                    <button onClick={handleDownload} disabled={downloading} className="button primary-button">
